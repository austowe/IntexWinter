...
namespace IntexWinter.Migrations.intex
{
    public partial class BurialIdChange : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id2 = table.Column<string>(maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mainburialmainid = table.Column<long>(name: "main$burialmainid", nullable: false),
                    maintextileid = table.Column<long>(name: "main$textileid", nullable: false),
                    BurialmainId = table.Column<long>(nullable: true),
                    TextileId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_burialmain_textile_textile_TextileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_burialmain_textile_TextileId",
                table: "burialmain_textile",
                column: "TextileId");
